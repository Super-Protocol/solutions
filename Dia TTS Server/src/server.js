...
var logger = logger_1.rootLogger.child({ module: 'server.js' });
var terminationHandler = function (signal) {
    logger.info("".concat(signal, " received. Stopping"));
    process.exit(0);
};
var handledSignals = ['SIGINT', 'SIGTERM'];
...
var run = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                serverConfig = (0, server_config_1.getServerConfig)();
                // Записываем TLS сертификаты с ограниченными правами
                return [4 /*yield*/, fs_1.default.promises.writeFile(serverConfig.privateKeyFilePath, serverConfig.tlsKey, {
                        mode: 384,
                    })];
            case 1:
                // Записываем TLS сертификаты с ограниченными правами
                _a.sent();
                return [4 /*yield*/, fs_1.default.promises.writeFile(serverConfig.certificateFilePath, serverConfig.tlsCert, {
                        mode: 384,
                    })];
            case 2:
                _a.sent();
                // Запускаем Dia-TTS-Server с HTTPS через uvicorn
                (0, child_process_1.spawn)('uvicorn', [
                    'server:app',
...
run().catch(function (err) {
    logger.fatal({ err: err }, "Dia-TTS-Server start command failed");
});
